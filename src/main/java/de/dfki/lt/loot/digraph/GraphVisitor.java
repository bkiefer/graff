...
public interface GraphVisitor<EdgeInfo> {
   ...
   */
  void startVertex(int v, DirectedGraph<EdgeInfo> g);

  /** This method is called when a vertex turns from white to gray */
  void discoverVertex(int v, DirectedGraph<EdgeInfo> g);

  /** This method is called when a vertex turns from gray to black */
  void finishVertex(int v, DirectedGraph<EdgeInfo> g);

  /** This method is called when a tree edge is used */
  void treeEdge(Edge<EdgeInfo> e, DirectedGraph<EdgeInfo> g);

  /** This method is called when a non tree edge is used */
  void nonTreeEdge(Edge<EdgeInfo> e, DirectedGraph<EdgeInfo> g);
